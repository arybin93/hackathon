...
class Person(TimeStampedModel):
    ...
    contractor = models.OneToOneField(User, on_delete=models.CASCADE, verbose_name='Подрядчик')
    permit = models.ForeignKey(Permit, null=True, blank=True, on_delete=models.SET_NULL, verbose_name='Пропуск')
...
class Document(TimeStampedModel):
    ...
    date_from = models.DateTimeField(blank=True, verbose_name='Срок действия', help_text='Дата и время (от)')
    date_to = models.DateTimeField(blank=True, verbose_name='Срок действия', help_text='Дата и время (до)')
